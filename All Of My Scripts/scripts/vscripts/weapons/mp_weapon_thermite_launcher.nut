...
global function MpWeaponThermiteLauncher_Init
global function OnProjectileCollision_weapon_thermite_launcher
global function OnWeaponActivate_ThermiteLauncher
global function OnWeaponDeactivate_ThermiteLauncher
...
void function MpWeaponThermiteLauncher_Init()
{
	PrecacheParticleSystem( PREBURN_EFFECT_ASSET )
	PrecacheParticleSystem( BURN_EFFECT_ASSET )
}

void function OnWeaponActivate_ThermiteLauncher( entity weapon )
{
	#if CLIENT
...
void function OnWeaponDeactivate_ThermiteLauncher( entity weapon )
{
	#if CLIENT
...
void function OnProjectileCollision_weapon_thermite_launcher( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical )
{
...
array<SegmentData> function CreateSpreadPattern( entity owner, entity inflictor, vector pos, vector dir, int stepCount, BurnDamageSettings burnSettings )
{
	...
	for ( int i = 0; i < stepCount; i++ )
	{
		...
		#if (true) && DEBUG_THERMITE_GRENADE_TRACES
