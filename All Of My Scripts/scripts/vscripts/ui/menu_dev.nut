...
void function SetupDefaultDevCommandsMP()
{
	...
	if ( IsSurvivalMenuEnabled() )
	{
		...
		SetupDevMenu( "Custom Weapons", SetDevMenu_CustomLoot, "main_weapon" )
        SetupDevMenu( "Custom Attachments", SetDevMenu_CustomLoot, "attachment" )
...
{
	RunClientScript("SetupCustomLoot", categories)
}
